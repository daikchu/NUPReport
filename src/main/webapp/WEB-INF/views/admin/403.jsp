...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    ...
    <div class="row m-n">
        <div class="col-sm-4 col-sm-offset-4">
            ...
            <article class="media">
                <div class="pull-left">
                    <span class="pull-left thumb-sm"><img src="<%=request.getContextPath()%>/assets/note/images/icon/cry.png" class="img-circle" style="opacity: 0.5"></span>
                </div>
            ...
            <a class="pull-right" href="<%=request.getContextPath()%>/j_spring_security_logout">Đăng xuất</a>
        </div>
    </div>
...
<footer id="footer">
    <div class="text-center padder">
        <p>
            <small>Quản lý tình hình thông tin mạng xã hội &copy; 2020</small>
        </p>
    </div>
</footer>
<!-- / footer -->
