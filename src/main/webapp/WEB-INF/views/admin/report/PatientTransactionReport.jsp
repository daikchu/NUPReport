...
<script src="<%=request.getContextPath()%>/assets/project/admin/report/PatientTransactionReport.js"></script>
<section id="content" ng-app="ospism" ng-controller="PatientTransactionReportController">
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="<%=request.getContextPath()%>/statistic/task/list">Patient Transaction Report</a></li>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row" style="margin-top:10px;">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <input id="dateFrom" ng-model="searchCondition.dateTo" autocomplete="off"
                    ...
                    <table class="table table-striped table-bordered m-b-none text-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="box-shadow-inner small_col text-center">Date</th>
                                ...
                                <th class="box-shadow-inner small_col text-center">Transaction Time</th>
                                <th class="box-shadow-inner small_col text-center">Transaction Amount ($)</th>
                                <th class="box-shadow-inner small_col text-center">Card Info</th>
                                <th class="box-shadow-inner small_col text-center">Time of NRIC Scan</th>
                                <th class="box-shadow-inner small_col text-center">Time of Recept Print</th>
                                <th class="box-shadow-inner small_col text-center">Duration (minisec)</th>
                                <th class="box-shadow-inner small_col text-center">Status</th>
                                <th class="box-shadow-inner small_col text-center">New Bills Paid</th>
                                <th class="box-shadow-inner small_col text-center">Outstanding Bills Paid</th>
                                <th class="box-shadow-inner small_col text-center">Total Bills Paid</th>
                            </tr>
                        ...
                        <tbody>
                            <tr ng-switch-default ng-repeat="item in page.items track by $index">
                                ...
                                <td class="align-center truong-text-verticel">{{item.date | date:'dd/MM/yyyy'  }}</td>
                                ...
                                <td class="align-center truong-text-verticel">{{item.transactionRefNo}}</td>
                                <td class="align-center truong-text-verticel">{{item.transactionTime}}</td>
                                <td class="align-center truong-text-verticel">{{item.transactionAmount}}</td>
                                <td class="align-center truong-text-verticel">{{item.cardInfo}}</td>
                                <td class="align-center truong-text-verticel">{{item.timeOfNRICScan}}</td>
                                <td class="align-center truong-text-verticel">{{item.timeOfReceptPrint}}</td>
                                <td class="align-center truong-text-verticel">{{item.duration}}</td>
                                <td class="align-center truong-text-verticel">Khong co mo ta</td>
                                <td class="align-center truong-text-verticel">{{item.newBillsPaids}}</td>
                                <td class="align-center truong-text-verticel">{{item.outStandingBillsPaid}}</td>
                                <td class="align-center truong-text-verticel">{{item.totalBuildsPaids}}</td>
