...
app.controller('unitAddCtrl', ['$scope', '$http', '$q', '$timeout', '$sce', function ($scope, $http, $q, $timeout, $sce) {
    $scope.unitId = unitId;
    $scope.searchCondition = {parentId: $scope.unitId, name: "", diaChi:""};
    $scope.page = page;
    $scope.pageCol = page;
    $scope.units = [];
    $scope.subUnits = [];
    ...
    $scope.subUnitAdd = {ten: "", diaChi: "", soDienThoai: "", cha_id: unitId};
    /*$scope.messageEditSubUnit = "";*/
    ...
    processDataForTreeView();

    
    function processDataForTreeView() {
        var treeObject = [
            {
                text:"Nhóm TT/TTBC", // Required
                ...
                children:
                    ...
                    {
                        text:"Đơn vị 1", // Required
                        checked:true, // Optional
                        id:15,otherDatas:"Other Datas", // Other Datas Optional
                        children:[ // Required
                            { text:"Nhóm 1" /* Required */, checked:true	},
                            { text:"Nhóm 2" /* Required */	}
                        ]
                    },
                    {
                        text:"Đơn vị 2", // Required
                        children:[
                            {
                                text:"Nhóm 3",
                                children:[
                                    {text:"Cộng tác viên 3",checked:true},
                                    {text:"Cộng tác viên 4"}
                                ]
                            }
                        ]
                    }
