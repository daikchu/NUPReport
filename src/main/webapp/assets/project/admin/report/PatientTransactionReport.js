...
app.controller('PatientTransactionReportController', ['$scope', '$http', '$q', '$timeout', '$sce', function ($scope, $http, $q, $timeout, $sce) {
    ...
    $http.get(preUrl + "/report/getPageDataPatientTransactionReport", {
        params: {
            p: 1,
