...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/accessibility", ["src/main/webapp/assets/js/highcharts/highcharts"], function (p) {
        a(p);
        a.Highcharts = p;
        return a
    ...
    p(a, "modules/accessibility/utils/htmlUtilities.js", [a["parts/Globals.js"]], function (a) {
        ...
        var n = a.merge, m = a.win, e = m.document;
        return {
    ...
    p(a, "modules/accessibility/utils/chartUtilities.js", [a["modules/accessibility/utils/htmlUtilities.js"], a["parts/Globals.js"]], function (a, h) {
        ...
        var k = a.stripHTMLTagsFromString, r = h.find;
        return {
            getChartTitle: function (a) {
                return k(a.options.title.text || a.langFormat("accessibility.defaultChartTitle", {chart: a}))
                ...
                for (var d = a.length, g; d--;) if (g = r(a[d].points || [], function (d) {
                    return d.x === b && d.y === c
                })) return g
            }, getSeriesFirstPointElement: l, getSeriesFromName: function (a, b) {
                return b ? (a.series || []).filter(function (c) {
                    return c.name === b
                }) : a.series
            }, getSeriesA11yElement: m, unhideChartElementFromAT: e, hideSeriesFromAT: function (a) {
    ...
    p(a, "modules/accessibility/KeyboardNavigationHandler.js", [a["parts/Globals.js"]], function (a) {
        ...
        l.prototype = {
            run: function (a) {
                var e = a.which || a.keyCode, l = this.response.noHandler, r = n(this.keyCodeMap, function (a) {
    ...
    p(a,
        "modules/accessibility/utils/DOMElementProvider.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, h, n) {
    ...
    p(a, "modules/accessibility/AccessibilityComponent.js",
        [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/EventProvider.js"], a["modules/accessibility/utils/DOMElementProvider.js"]], function (a, h, n, m, e, k) {
            ...
            var f = a.win, b = f.document, c = a.merge, d = a.fireEvent;
            a = h.extend;
            var g = n.removeElement, t = n.getFakeMouseEvent, w = m.unhideChartElementFromAT;
            l.prototype = {
                initBase: function (a) {
                    this.chart = a;
                    ...
                    var a = this.chart, c = a.renderer.box;
                    ...
                    var q = a.element, u = this.createElement("button"),
    ...
    p(a, "modules/accessibility/KeyboardNavigation.js", [a["parts/Globals.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/EventProvider.js"]], function (a, h, n, m) {
        ...
        var l = a.merge, r = a.win, f = r.document, b = h.getElement;
        e.prototype = {
            init: function (a, d) {
                ...
                if (!(this.keyboardReset || this.chart.pointer && this.chart.pointer.chartPosition)) {
                    var a = this.chart, d = this.modules && this.modules[this.currentModuleIx || 0];
                ...
                var a = this.chart, d = this.exitAnchor = f.createElement("div");
                l(!0, d.style, {
                    position: "absolute",
                    width: "1px",
                    height: "1px",
    ...
    p(a, "modules/accessibility/components/LegendComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
        function (a, h, n, m, e) {
            h = h.extend;
            var l = e.stripHTMLTagsFromString, r = e.removeElement;
            a.Chart.prototype.highlightLegendItem = function (f) {
                var b = this.legend.allItems, c = this.highlightedLegendItemIx;
                if (b[f]) {
                    b[c] && a.fireEvent(b[c].legendGroup.element, "mouseout");
                    c = this.legend;
                    var d = c.allItems[f].pageIx, g = c.currentPage;
            ...
            h(e.prototype, {
                init: function () {
                    ...
                    var a = this.chart.legend, b = a.currentPage || 1;
                    ...
                    var a = this.chart, b = a.legend && a.legend.allItems, c = a.options.legend.accessibility || {};
                    ...
                    var b = this, c = this.chart.langFormat("accessibility.legend.legendItem", {
                        chart: this.chart,
                        itemName: l(a.name)
                    });
                    ...
                    var c = this.keyCodes, d = a.response, g = this.chart, e = g.options.accessibility,
                    ...
                    var a = this.chart, b = a.colorAxis && a.colorAxis.length,
                    ...
                    var b = this.chart, c = b.legend.allItems.length - 1;
                    a = 0 < a ? 0 : c;
    ...
    p(a, "modules/accessibility/components/MenuComponent.js",
        [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, h, n, m, e, k) {
            h = h.extend;
            var l = e.unhideChartElementFromAT, f = k.removeElement, b = k.getFakeMouseEvent;
            ...
            h(a.prototype,
                {
                    init: function () {
                        ...
                        var a = this.chart, d = a.exportContextMenu;
                        ...
                        var a = this.chart, b = a.exportDivElements;
                        ...
                        var a = this.keyCodes, b = this.chart, g = this;
                        return new m(b, {
                        ...
                        var b = this.chart, c = b.options.accessibility;
                        a = a.response;
                        for (var e = b.highlightedExportItemIx || 0; e--;) if (b.highlightExportItem(e)) return a.success;
                        return c.keyboardNavigation.wrapAround ? (b.highlightLastExportItem(), a.success) : a.prev
                    }, onKbdNext: function (a) {
                        var b = this.chart, c = b.options.accessibility;
                        a = a.response;
                        for (var e = (b.highlightedExportItemIx || 0) + 1; e < b.exportDivElements.length; ++e) if (b.highlightExportItem(e)) return a.success;
    ...
    p(a, "modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/EventProvider.js"], a["modules/accessibility/utils/chartUtilities.js"]],
        function (a, h, n, m, e) {
            function k(a) {
                var b = a.index, c = a.series.points, q = c.length;
                if (c[b] !== a) for (; q--;) {
                    if (c[q] === a) return q
                } else return b
            }
            ...
            function l(a) {
                var b = a.chart.options.accessibility.keyboardNavigation.seriesNavigation,
                    c = a.options.accessibility || {}, d = c.keyboardNavigation;
            ...
            function b(a, b, c, d) {
                var q = Infinity, u = b.points.length, e = function (a) {
            ...
            var g = h.extend, t = h.defined, w = e.getPointFromXY, y = e.getSeriesFromName;
            ...
            a.Chart.prototype.highlightAdjacentPoint =
                function (a) {
                    var b = this.series, c = this.highlightedPoint, d = c && k(c) || 0, v = c && c.series.points,
            ...
            a.Series.prototype.highlightFirstValidPoint = function () {
                var a = this.chart.highlightedPoint, b = (a && a.series) === this ? k(a) : 0;
                a = this.points;
                var c = a.length;
                if (a && c) {
                    for (var d = b; d < c; ++d) if (!f(a[d])) return a[d].highlight();
                    for (; 0 <= b; --b) if (!f(a[b])) return a[b].highlight()
                }
                return !1
            };
            ...
            a.Chart.prototype.highlightAdjacentPointVertical = function (a) {
                ...
                this.series.forEach(function (e) {
                    l(e) || e.points.forEach(function (v) {
                        if (t(v.plotY) &&
                            t(v.plotX) && v !== b) {
                            var g = v.plotY - b.plotY, q = Math.abs(v.plotX - b.plotX);
            ...
            g(d.prototype, {
                init: function () {
                    var b = this, d = this.chart, e = this.eventProvider = new m;
                    ...
                    var a = this.lastDrilledDownPoint, b = this.chart, c = a && y(b, a.seriesName), d;
                    ...
                    return new n(c, {
                        keyCodeMap: [[d ? [b.up, b.down] : [b.left, b.right], function (b) {
    ...
    p(a, "modules/accessibility/components/SeriesComponent/SeriesDescriber.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"]], function (a, h, n, m) {
        ...
        function b(a, b) {
            var c = a.series.chart, d = c.options.accessibility.point || {};
        ...
        function g(b) {
            var c = b.series, d = c.chart, e = d.options.accessibility.point || {};
        ...
        function y(a) {
            var c = a.series, d = c.chart.options.accessibility.point || {}, e = c.tooltipOptions || {},
            ...
            (b || c) && a.points.forEach(function (a) {
                ...
                if (!(d = a.graphic && a.graphic.element)) {
                    if (c) {
                        ...
                        g = g ? {x: z(a.plotX, g.plotX, 0), y: z(a.plotY, g.plotY, 0)} : {
                            x: z(a.plotX, 0),
                            y: z(a.plotY, 0)
                        };
        ...
        function A(a) {
            var b = a.chart, e = b.types || [], g = c(a), v = function (c) {
                return b[c] && 1 < b[c].length && a[c]
            }, t = d(a, "xAxis"), f = d(a, "yAxis"), q = {
                name: a.name || "",
                ix: a.index + 1,
        ...
        var C = a.numberFormat, v = a.find, x = h.isNumber, z = h.pick, B = h.defined, p = n.stripHTMLTagsFromString,
            E = n.reverseChildNodes, F = m.getAxisDescription, G = m.getSeriesFirstPointElement,
            H = m.getSeriesA11yElement, I = m.unhideChartElementFromAT;
        return {
            describeSeries: function (a) {
                var b = a.chart, c = G(a), d = H(a);
                if (d) {
                    d.lastChild ===
                    c && E(d);
                    u(a);
    ...
    p(a, "modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/components/SeriesComponent/SeriesDescriber.js"],
        ...
        var c = h.extend, d = h.defined, g = n.visuallyHideElement, t = m.getChartTitle,
            l = e.defaultPointDescriptionFormatter, y = e.defaultSeriesDescriptionFormatter;
        h = function (a) {
            this.chart = a
        };
        c(h.prototype, {
            init: function () {
                ...
                var a = this.chart, b = this.domElementProvider.createElement("div"),
    ...
    p(a, "modules/accessibility/components/SeriesComponent/forcedMarkers.js", [a["parts/Globals.js"]], function (a) {
        function h(a) {
            l(!0, a, {marker: {enabled: !0, states: {normal: {opacity: 0}}}})
        }
    ...
    p(a, "modules/accessibility/components/SeriesComponent/SeriesComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js"], a["modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js"], a["modules/accessibility/components/SeriesComponent/forcedMarkers.js"], a["modules/accessibility/utils/chartUtilities.js"],
        ...
        h = h.extend;
        var b = r.hideSeriesFromAT, c = f.describeSeries;
    ...
    p(a, "modules/accessibility/components/ZoomComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
        function (a, h, n, m, e, k) {
            var l = h.extend, f = h.pick, b = e.unhideChartElementFromAT, c = k.setElAttrs, d = k.removeElement;
    ...
    p(a, "modules/accessibility/components/RangeSelectorComponent.js", [a["parts/Globals.js"],
        ...
        h = h.extend;
        var r = e.unhideChartElementFromAT, f = k.setElAttrs;
        a.Chart.prototype.highlightRangeSelectorButton = function (a) {
            var b = this.rangeSelector.buttons, d = this.highlightedRangeSelectorItemIx;
        ...
        h(a.prototype, {
            onChartUpdate: function () {
                ...
                var a = this.chart, c = this.keyCodes, d = this;
                return new m(a, {
                ...
                var b = a.response, e = this.keyCodes, f = this.chart,
                ...
                var a = this.chart, c = this.keyCodes, d = this;
                return new m(a, {
                    keyCodeMap: [[[c.tab, c.up, c.down], function (a, b) {
    ...
    p(a, "modules/accessibility/components/InfoRegionsComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"],
        ...
        var r = a.win.document, f = a.format, b = h.extend, c = h.pick, d = m.unhideChartElementFromAT,
            g = m.getChartTitle, l = m.getAxisDescription, w = e.addClass, p = e.setElAttrs, q = e.escapeStringForHTML,
            u = e.stripHTMLTagsFromString, A = e.getElement, C = e.visuallyHideElement;
        ...
        b(h.prototype, {
            init: function () {
                ...
                var b = this.chart, c = this.screenReaderSections[a], e = c.buildContent(b),
                ...
                var b = this.chart, c = b.options.accessibility.screenReaderSection.beforeChartFormat,
                    d = this.getAxesDescription(), e = "hc-linkto-highcharts-data-table-" + b.index;
                d = {
                    chartTitle: g(b),
                ...
                var b = this.chart;
                b = b.langFormat("accessibility.table.viewAsDataTableButtonText", {chart: b, chartTitle: g(b)});
                return '<a id="' + a + '">' + b + "</a>"
                ...
                var b = this.viewDataTableButton = A(a), c = this.chart;
    ...
    p(a, "modules/accessibility/components/ContainerComponent.js",
        [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/AccessibilityComponent.js"]], function (a, h, n, m, e) {
            ...
            a = h.extend;
            var r = n.stripHTMLTagsFromString, f = m.unhideChartElementFromAT, b = m.getChartTitle;
            n = function () {
            };
            n.prototype = new e;
            a(n.prototype, {
                onChartUpdate: function () {
                    ...
                    var a = this.chart, d = "highcharts-title-" + a.index,
                        e = r(a.langFormat("accessibility.svgContainerTitle", {chartTitle: b(a)}));
                    if (e.length) {
                    ...
                    var a = this.chart, d = r(a.langFormat("accessibility.svgContainerLabel", {chartTitle: b(a)}));
                    a.renderer.box &&
                    d.length && a.renderer.box.setAttribute("aria-label", d)
                }, setGraphicContainerAttrs: function () {
                    var a = this.chart, d = a.langFormat("accessibility.graphicContainerLabel", {chartTitle: b(a)});
    ...
    p(a, "modules/accessibility/high-contrast-mode.js", [a["parts/Globals.js"]], function (a) {
        var h = a.isMS, l = a.win, m = l.document;
        return {
    ...
    p(a, "modules/accessibility/options/deprecatedOptions.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, h) {
        ...
        function e(a, b, c,
            ...
            var g = d(a.options, b), f = d(a.options, c);
        ...
        return function (a) {
            ...
            e(a, ["accessibility", "keyboardNavigation"], ["accessibility",
                "keyboardNavigation", "seriesNavigation"], {skipNullPoints: ["skipNullPoints"], mode: ["mode"]});
    ...
    p(a, "modules/accessibility/a11y-i18n.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, h) {
        function l(a, k) {
            var e = a.indexOf("#each("), f = a.indexOf("#plural("), b = a.indexOf("["), c = a.indexOf("]");
            if (-1 < e) {
                ...
                e = Number(b[1]);
                a = "";
                if (k = k[b[0]]) for (e = isNaN(e) ? k.length : e, e = 0 > e ? k.length + e : Math.min(e, k.length), b = 0; b < e; ++b) a += d + k[b] + f;
                return a.length ? a : ""
            }
            if (-1 < f) {
    ...
    p(a, "modules/accessibility/focusBorder.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, h) {
        var l = a.addEvent, m = h.extend, e = h.pick;
        ...
        a.Chart.prototype.setFocusToElement = function (a, e) {
            ...
            (e = e || a.element) && e.focus && (e.hcEvents && e.hcEvents.focusin || l(e, "focusin", function () {
            }), e.focus(), f.hideBrowserFocusOutline && (e.style.outline = "none"));
    ...
    p(a, "modules/accessibility/accessibility.js", [a["modules/accessibility/utils/chartUtilities.js"], a["parts/Globals.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigation.js"], a["modules/accessibility/components/LegendComponent.js"], a["modules/accessibility/components/MenuComponent.js"], a["modules/accessibility/components/SeriesComponent/SeriesComponent.js"],
        ...
        var r = m.extend, x = h.addEvent, z = h.win.document, B = h.merge, D = h.fireEvent;
        ...
        l.prototype = {
            init: function (a) {
                ...
                var a =
                    this.chart, e = a.options.accessibility;
                this.components = {
                    container: new t,
                    infoRegions: new g,
                    legend: new p,
