...
*/
(function (c) {
    "object" === typeof module && module.exports ? (c["default"] = c, module.exports = c) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["src/main/webapp/assets/js/highcharts/highcharts", "highcharts/modules/exporting"], function (q) {
        c(q);
        c.Highcharts = q;
        return c
    ...
    q(c, "mixins/download-url.js", [c["parts/Globals.js"]], function (b) {
        var a = b.win, c = a.navigator, q = a.document, h = a.URL || a.webkitURL || a,
        ...
        b.dataURLtoBlob =
            function (b) {
                if ((b = b.match(/data:([^;]*)(;base64)?,([0-9A-Za-z+/]+)/)) && 3 < b.length && a.atob && a.ArrayBuffer && a.Uint8Array && a.Blob && h.createObjectURL) {
                    var c = a.atob(b[3]), e = new a.ArrayBuffer(c.length);
        ...
        b.downloadURL = function (e, h) {
            ...
            if ("string" === typeof e || e instanceof String || !c.msSaveOrOpenBlob) {
                ...
                if ("undefined" !== typeof p.download) p.href = e, p.download = h, q.body.appendChild(p), p.click(), q.body.removeChild(p); else try {
    ...
    q(c, "modules/export-data.src.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function (b, a) {
        function c(b, a) {
            var c = n.navigator, w = -1 < c.userAgent.indexOf("WebKit") && 0 > c.userAgent.indexOf("Chrome"),
        ...
        var q = a.defined, h = a.extend, f = a.isObject, e = a.pick, n = b.win, p = n.document, d = b.seriesTypes,
            A = b.downloadURL, C = b.fireEvent;
        b.setOptions({
            exporting: {
                csv: {
        ...
        b.Chart.prototype.getDataRows = function (a) {
            ...
            this.series.forEach(function (k) {
                var t = k.options.keys || k.pointArrayMap || ["y"], r = t.length, v = !k.requireSorting && {},
                    f = l.indexOf(k.xAxis), B = D(k, t), m;
        ...
        b.Chart.prototype.getCSV = function (a) {
            var b = "", c = this.getDataRows(), d = this.options.exporting.csv,
                ...
                h = e(d.itemDelimiter, "," === l ? ";" : ","), f = d.lineDelimiter;
        ...
        b.Chart.prototype.getTable = function (a) {
            var b = '<table id="highcharts-data-table-' + this.index + '">', c = this.options,
                d = a ? (1.1).toLocaleString()[1] : ".", h = e(c.exporting.useMultiLevelHeaders, !0);
            a = this.getDataRows(h);
            var f = 0, l = h ? a.shift() : null, q = a.shift(), n = function (a, b, c, h) {
                var g = e(h, "");
                b = "text" + (b ? " " + b : "");
