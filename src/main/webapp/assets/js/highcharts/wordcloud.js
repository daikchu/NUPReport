...
(function (a) {
    ...
    k(a, "modules/wordcloud.src.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["mixins/draw-point.js"], a["mixins/polygon.js"]],
        function (a, e, k, l) {
            ...
            e = a.noop;
            var I = a.find, J = l.getBoundingBoxFromPolygon, K = l.getPolygon, F = l.isPolygonsColliding,
                L = l.movePolygon, B = a.Series;
            a.seriesType("wordcloud", "column", {
                ...
                drawPoints: function () {
                    var a = this, d = a.hasRendered, c = a.xAxis, e = a.yAxis, l = a.group, k = a.options,
                        r = k.animation, t = k.allowExtendPlayingField, p = a.chart.renderer, n = p.text().add(l),
                        q = [], y = a.placementStrategy[k.placementStrategy], z = k.rotation,
                        F = a.points.map(function (b) {
                            return b.weight
