...
(function (za, N, l) {
    var M = function (g) {
        ...
        function Ra(a, b, c) {
            ...
            d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : O(a, 0, "Unknown paging customer: " + b, 5);
        ...
        p = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) O(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    y(k, "aoDrawCallback", h.fnDrawCallback, "customer");
                    y(k, "aoServerParams", h.fnServerParams, "customer");
                    y(k, "aoStateSaveParams", h.fnStateSaveParams, "customer");
                    y(k, "aoStateLoadParams", h.fnStateLoadParams, "customer");
                    y(k, "aoStateLoaded", h.fnStateLoaded, "customer");
                    y(k, "aoRowCallback", h.fnRowCallback, "customer");
                    y(k, "aoRowCreatedCallback", h.fnCreatedRow, "customer");
                    y(k, "aoHeaderCallback", h.fnHeaderCallback, "customer");
                    y(k, "aoFooterCallback", h.fnFooterCallback,
                        "customer");
                    y(k, "aoInitComplete", h.fnInitComplete, "customer");
                    y(k, "aoPreDrawCallback", h.fnPreDrawCallback, "customer");
                    n = k.oClasses;
